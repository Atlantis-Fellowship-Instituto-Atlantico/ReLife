...
export class RelifeBD1666408100506 implements MigrationInterface {
    name = 'RelifeBD1666408100506'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(45) NOT NULL, "last_name" character varying(45) NOT NULL, "cpf" character varying(11) NOT NULL, "phone" character varying(15) NOT NULL, "email" character varying(40) NOT NULL, "password" character varying NOT NULL, "isActive" boolean NOT NULL, "role_id" integer, "address_id" uuid, CONSTRAINT "REL_1b05689f6b6456680d538c3d2e" UNIQUE ("address_id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "institutions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "institution_name" character varying(100) NOT NULL, "responsible_name" character varying(150) NOT NULL, "cnpj" character varying(20) NOT NULL, "phone" character varying(15) NOT NULL, "email" character varying(40) NOT NULL, "password" character varying NOT NULL, "isActive" boolean NOT NULL, "role_id" integer, "address_id" uuid, CONSTRAINT "REL_e7793a6b806da38011d61aea21" UNIQUE ("role_id"), CONSTRAINT "REL_f6debf818490ee14c2fbfa3001" UNIQUE ("address_id"), CONSTRAINT "PK_0be7539dcdba335470dc05e9690" PRIMARY KEY ("id"))`);
