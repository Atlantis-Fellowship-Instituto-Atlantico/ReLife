...
export class FirstMigration1666067331539 implements MigrationInterface {
    name = 'FirstMigration1666067331539'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "acessLevels" ("id" SERIAL NOT NULL, "acess_type" character varying(20) NOT NULL, CONSTRAINT "PK_5191dffbc2c5cc4c32f293be005" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(45) NOT NULL, "last_name" character varying(45) NOT NULL, "cpf" character varying(11) NOT NULL, "telephone" character varying(15) NOT NULL, "email" character varying(40) NOT NULL, "user_name" character varying(40) NOT NULL, "password" character varying(25) NOT NULL, "isActive" boolean NOT NULL, "level_id" integer, "address_id" uuid, CONSTRAINT "REL_08f642b752f63f945086eccbc8" UNIQUE ("level_id"), CONSTRAINT "REL_1b05689f6b6456680d538c3d2e" UNIQUE ("address_id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "institutions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "institution_name" character varying(100) NOT NULL, "responsible_name" character varying(150) NOT NULL, "cnpj" character varying(20) NOT NULL, "telephone" character varying(15) NOT NULL, "email" character varying(40) NOT NULL, "password" character varying(25) NOT NULL, "isActive" boolean NOT NULL, "level_id" integer, "address_id" uuid, CONSTRAINT "REL_6bd690cb12c94b01c0d2d3dc1e" UNIQUE ("level_id"), CONSTRAINT "REL_f6debf818490ee14c2fbfa3001" UNIQUE ("address_id"), CONSTRAINT "PK_0be7539dcdba335470dc05e9690" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_08f642b752f63f945086eccbc8d" FOREIGN KEY ("level_id") REFERENCES "acessLevels"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "institutions" ADD CONSTRAINT "FK_6bd690cb12c94b01c0d2d3dc1e6" FOREIGN KEY ("level_id") REFERENCES "acessLevels"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "institutions" DROP CONSTRAINT "FK_6bd690cb12c94b01c0d2d3dc1e6"`);
        ...
        await queryRunner.query(`DROP TABLE "acessLevels"`);
    }
